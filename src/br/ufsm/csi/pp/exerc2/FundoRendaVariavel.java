...
public class FundoRendaVariavel extends Conta{
    public FundoRendaVariavel(String numero, String cpfTitular, double saldo, boolean especial, double limite) {
    ...
    public String getTipoConta() {
        return "Fundo de Renda Variável";
    }
}
